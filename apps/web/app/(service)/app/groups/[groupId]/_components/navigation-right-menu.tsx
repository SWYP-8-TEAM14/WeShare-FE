...
export default function NavigationRightMenu() {
  const [openAlert, setOpenAlert] = React.useState<null | "group-leave">(null);
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogTitle>그룹에서 탈퇴할까요</AlertDialogTitle>
            <AlertDialogDescription>
              더이상 해당 그룹의 물건을 이용할 수 없습니다
            </AlertDialogDescription>
          </AlertDialogHeader>
