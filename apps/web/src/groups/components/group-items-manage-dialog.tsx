import GroupItemsAddDialog from "@/groups/components/group-items-add-dialog";
...
export default function GroupItemsManageDialog({
  children,
}: {
    ...
    <FullScreenDialog>
      ...
      <FullScreenDialogContent>
        <TopNavigation>
          ...
          <TopNavigationTitle>
            <FullScreenDialogTitle>그룹 물품 관리</FullScreenDialogTitle>
          </TopNavigationTitle>
        </TopNavigation>
